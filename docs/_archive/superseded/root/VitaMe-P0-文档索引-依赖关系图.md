...
| 文件 | 类型 | 解决什么问题 | 主要使用者 |
|---|---|---|---|
| `docs/product/P0-执行总纲.md` | Brief | 锁定 P0 唯一定位、主场景、主链路、不做什么 | 创始人 / 产品 / 工程负责人 |
| `docs/product/用户上下文.md` | Taxonomy | 定义问什么、什么时候问、什么时候不问 | 产品 / 交互 / 后端 |
| `docs/product/风险判定矩阵.md` | Decision Matrix | 定义红黄灰绿、证据层级、结果合并和 CTA | 产品 / 后端 / QA / 医学审核 |
| `docs/engineering/specs/api-contract.md` | Contract | 锁定对象、字段、接口和错误码 | 前后端 / Claude Code |
| `docs/engineering/specs/test-matrix.md` | Test Matrix | 锁定黄金样例、回归测试、Demo 验收 | QA / 产品 / 工程 |
| `docs/engineering/specs/metrics-instrumentation.md` | Metrics Spec | 锁定事件、漏斗、激活、回访与看板口径 | 产品分析 / 前后端 |
| `docs/product/数据白名单.md` | Data Policy | 冻结 P0 真正接哪些源、哪些字段、怎么降级 | 后端 / 数据 / 产品 |
| `docs/product/信任与Claims边界.md` | Trust Policy | 定义对外能说什么、不能说什么 | 产品 / 设计 / 运营 / 创始人 |
